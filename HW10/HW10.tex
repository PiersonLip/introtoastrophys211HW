...
\[M_{wd} = .7M_\odot, \qquad r_{wd} = 7 \times 10^6 \si{m}, \qquad P_{wd} = 1.337 \text{s}\]
...
\begin{tabular}{
  |S[table-format=3.0]|
   S[table-format=2.1]|
   S[scientific-notation=true, table-format=1.2e2]|
   S[scientific-notation=true, table-format=1.2e2]|
}
\hline
\multicolumn{1}{|c|}{$v_c$ (\si{\kms})} &
\multicolumn{1}{c|}{$r$ (\si{\kpc})} &
\multicolumn{1}{c|}{$M(<r)$ (\si{\kilogram})} &
\multicolumn{1}{c|}{$M(<r)$ (\si{\Msun})} \\
\hline
255 & 0.4  & 1.20e40 & 6.05e9  \\
192 & 2.8  & 4.77e40 & 2.40e10 \\
220 & 8.0  & 1.79e41 & 9.00e10 \\
235 & 17.0 & 4.34e41 & 2.18e11 \\
\hline
\end{tabular}
\caption{This has got to be a Vera Rubin reference right??}
\end{table}
