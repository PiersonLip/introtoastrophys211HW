...
\[d = 800\text{pc}\]
We find \dots
\[m = 5\log(800)-5 -1.1 \boxed{\approx 8.415}\]
...
\subsubsection{Upper bound of T }
\def\phv{13.6}
\def\k{1.3806 \times 10^{-23}}
Given \dots
\[E = hv = hc/\lambda\]
\[k = \k\]
\[hv = \phv J = 13.6ev \times 1.6021810^{-19}J/ev = 2.1789 \times 10^{-18} ev \]

We find that \dots
\[2.1789 \times 10^{-18} > \k T\]
\[\frac{2.1789 \times 10^{-18}}{\k} > T \]
\[\boxed{157827K \gtrsim T} \]

Given \dots
% \[I_\nu = \frac{2h\nu^3}{c^2} \frac{1}{e^{h\nu/k_BT} - 1}, \qquad I_\nu = \frac{2h\nu^3}{(c^2)(e^{h\nu/k_BT)}} \] 
% \[I_\nu \propto \nu^3 e^{-h\nu/kT}\]
% \[L_\star = (4\pi R^2)\pi I_\nu\]
% \[Q_\star = \int \frac{L_\star}{h\nu}d\nu\]
% \[\int x^2 e^{cx} = e^{cx}(\frac{x^2}{c} - \frac{2x}{c^2} + \frac{2}{c^3})\]
% We find \dots
% \[Q_\star = \int \frac{(4\pi R^2)\pi \frac{2h\nu^{\cancel{3}2}}{(c^2)(e^{h\nu/k_BT)}}}{h\cancel{\nu}}d\nu\]
% \[Q_\star = \frac{(4\pi^2 R^2)}{c^2}(2h)\int \frac{\nu^2}{(e^{h\nu/k_BT)}}d\nu\]
% \[\qquad c = \frac{(4\pi^2 R^2)}{c^2}(2h)\]
% \def\c{\frac{(4\pi^2 R^2)}{c^2}(2h)}

% \[Q_\star = c\int \frac{\nu^2}{(e^{h\nu/k_BT)}}d\nu\]
% \[u = h\nu/k_B T, \qquad \nu = k_B T/h, \qquad du = h/k_BT\]

% \[Q_\star = \frac{k_BT}{h} \c (k_B T/h)^2\int \frac{u^2}{e^{u}}du\]

% \def\ctwo{\frac{k_BT}{h} \c (k_B T/h)^2}

% \[Q_\star = \ctwo\left(e^{-u}(\frac{u^2}{-1} - \frac{2u}{1} + \frac{2}{-1})\right)\]
% \def\unum{h\nu/k_B T}
% \[Q_\star = \ctwo\left(e^{-\unum}(\frac{\unum^2}{-1} - \frac{2\unum}{1} + \frac{2}{-1})\right)\]
...
\[
Q_\star = \int_{\nu_0}^{\infty} \frac{L_\nu}{h\nu}\,d\nu
        = \frac{8\pi^2 R^2}{c^2}\int_{\nu_0}^{\infty} \nu^2 e^{-h\nu / k_B T}\,d\nu.
\]

Let\dots
\[
u = \frac{h\nu}{k_B T}, \qquad \nu = \frac{k_B T}{h}u, \qquad d\nu = \frac{k_B T}{h}\,du.
\]

Substituting gives\dots
\[
Q_\star = \frac{8\pi^2 R^2}{c^2}\left(\frac{k_B T}{h}\right)^3 
\int_{u_0}^{\infty} u^2 e^{-u}\,du,
\qquad u_0 = \frac{h\nu_0}{k_B T} = \frac{E_0}{k_B T}.
\]

Using the identity\dots
\[
...
\[
Q_\star = 
\frac{8\pi^2 R^2}{c^2}\left(\frac{k_B T}{h}\right)^3 
e^{-E_0 / k_B T}
\left[
\left(\frac{E_0}{k_B T}\right)^2 
+ 2\frac{E_0}{k_B T} + 2
\right].
\]
Solving for \(T = 43650\) and \(R = 10.7R_\odot\)\dots

\[\boxed{Q_\star = 2.197 \times 10^{49} \text{s}^{-1}}\]

\subsubsection{}
Given\dots 
\[R_s = \left(\frac{3}{4\pi} \frac{Q_\star }{n_e^2\alpha (T_e)}\right)^{1/3}\]
\[\qquad n_e = 10^9 m^{-3},
\qquad \alpha = 2.6 \times 10^{-19}m^3s^{-1},
\qquad Q_\star = 2.197 \times 10^{49} \text{s}^{-1}\]
Solving we find that \dots

\[
\boxed{
   R_s \approx 2.7224349\times 10^{16}\text{m} \approx .882\text{pc} \approx 88\% \text{ of the normal distance}
}\]
...
\[\boxed{r_f \approx 7.496 \times 10^{-15} \text{m}}\]
...
\[\boxed{E_{pNuc} = \frac{1.167165 \times 10^{-12}}{12} \approx 9.7263783 \times 10^{-14} \text{J}}\]
...
t_{He Burn} = \frac{E_{\mathrm{tot}}}{L}
   ...
   \approx 3.64\times10^{15}\ \mathrm{s}
...
\[1/2mv_{dm}^2 = -\frac{GMm}{r_0} + \frac{GMm}{r_0}\]
...
\text{Assuming in-fall means negative v\dots}
\[v_{dm} = -\sqrt{2GM\left(\frac{1}{r} - \frac{1}{r_0}\right)}\]
\pagebreak
